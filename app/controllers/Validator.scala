...
trait Validator { this: Controller =>
  ...
  def onlyData(data: String, dataFormat: String) = {
    validate_get(data, Some(dataFormat), DEFAULT_SHOW_DATA, None, None, "", None, DEFAULT_CUT, false)
  }
  ...
  def validate_get(
    str_data: String, dataFormat: Option[String], showData: Boolean, opt_schema: Option[String], schemaFormat: Option[String], schemaVersion: String, opt_iri: Option[String], cut: Int, showSchema: Boolean) = Action.async {
