...
object ApiHelper {
  ...
  private val options = PlantUMLOptions(watermark =
    Some("Generated by [[https://rdfshape.weso.es rdfshape]]")
  )
  ...
  private[server] def schemaConvert(
  ...
  private[server] def validateStr(
      data: String,
  ...
  private[server] def dataExtract(
      rdf: RDFReasoner,
  ...
  private[server] def convertSchema(
      schema: Schema,
  ...
  private[server] def dataInfoFromString(
      data: String,
  ...
  private[server] def mkJsonErr(msg: String) =
