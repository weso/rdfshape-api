...
import es.weso.utils.IOUtils.{ESIO, either2es, io2es}
...
object DataInfo {
  ...
  def dataInfoFromRdf(
    ...
    either.map(
      _.fold(e => DataInfo.fromMsg(e.getMessage), r => r)
    )
  }
